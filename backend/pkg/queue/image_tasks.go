...
func (q *ImageTaskQueue) EnqueueAIProcessing(
	...
	// AI задачи имеют высокий приоритет по умолчанию
...
// EnqueuePriorityAIProcessing добавляет приоритетную задачу AI обработки
...
// handleAIPriority обрабатывает приоритетную задачу AI обработки
