...
// GetPartnerFromContext retrieves partner information from context
func GetPartnerFromContext(c *fiber.Ctx) (partnerID uuid.UUID, domain string, brandName string, isPartner bool) {
