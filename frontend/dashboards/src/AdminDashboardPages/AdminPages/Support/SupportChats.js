...
import { Row, Col, Card, CardBody, CardHeader, CardTitle, Button, Table, Modal, ModalHeader, ModalBody, ModalFooter, Input } from 'reactstrap'
...
const SupportChats = () => {
  ...
  // Пуллинг сообщений открытого чата каждые 5 секунд
  useEffect(() => {
    if (!selected) return
    let disposed = false
    const tick = async () => {
