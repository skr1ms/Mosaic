...
const PartnersList = () => {
    ...
    const [sortKey, setSortKey] = useState('created_at'); // 'created_at' | 'brand_name'
    ...
    const loadPartners = async () => {
        try {
            ...
            // Передаем сортировку на бэкенд, чтобы не тащить лишние данные на фронт
    ...
    useEffect(() => {
        // Загружаем агрегированную статистику по всем партнёрам для колонки "Купоны"
