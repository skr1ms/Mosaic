...
const CreatePartner = () => {
    ...
    const validateForm = () => {
        ...
        // Валидаторы backend: минимум 8 символов, заглавная буква, цифра, спецсимвол
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Если указан логотип — загружаем отдельным запросом на /logo
    ...
    return (
        <Fragment>
            ...
            {submitMessage && (
                <Alert color={submitMessage.includes(t('partners.partner_created_successfully')) ? 'success' : 'danger'}>
                    {submitMessage}
                </Alert>
            )}
                            ...
                            <CardBody>
                                ...
                                >
                                    {isSubmitting ? (
                                        ...
                                        <>
                                            <i className="pe-7s-check"></i> {t('common.create')}
                                        </>
                                    )}
                                </Button>
                            </CardBody>
