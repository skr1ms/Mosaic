...
const Main = (props) => {
  ...
  useEffect(() => {
    const evaluateAuth = () => {
      setIsLoading(true);
      try {
        // Используем нашу функцию проверки токена (теперь синхронная)
    ...
    // Проверка при монтировании и при изменении маршрута
    evaluateAuth();

    // Реагировать на пользовательское событие, кидаем его при логине/логауте
