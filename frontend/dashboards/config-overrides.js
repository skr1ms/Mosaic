...
module.exports = function override(config, env) {
    ...
    // Ensure ESLint cache location is writable (avoid node_modules/.cache on some systems)
    ...
    if (env === 'development') {
        ...
        // Add chunk loading timeout and retry settings
        config.output = {
            ...config.output,
        ...
        // Add webpack chunk loading optimization
        config.optimization = {
            ...config.optimization,
            splitChunks: {
