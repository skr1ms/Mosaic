        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          ...
          <div className="text-center sm:text-left lg:col-span-1 sm:col-span-2 lg:col-span-1">
            ...
            <div className="space-y-3">
              {partner?.telegram && (
                <a 
                  href={partner.telegram.startsWith('http') ? partner.telegram : `https://t.me/${partner.telegram.replace('@', '')}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center sm:justify-start space-x-3 text-gray-300 hover:text-white transition-colors text-sm sm:text-base"
                >
