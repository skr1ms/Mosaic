          ...
          <div className="space-y-4">
            ...
            <div className="bg-brand-accent/5 rounded-lg p-4">
              ...
              <div className="mt-2 w-full bg-brand-accent/20 rounded-full h-2">
                <div 
                  ...
                  style={{ width: `${(queueStatus.currently_processing / queueStatus.max_concurrent) * 100}%` }}
                ></div>
              </div>
            </div>
            ...
            {imageId && (
              <div className="bg-brand-primary/5 rounded-lg p-4">
                <div className="flex items-center">
                  <svg className="h-5 w-5 text-brand-primary mr-2" fill="currentColor" viewBox="0 0 20 20">
